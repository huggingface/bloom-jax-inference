...
inputs = {"prompt": "one" * 256, "max_new_tokens": 64, "gen_method": "sampling"}
tpu_manager.generate(inputs)

print("cpmpling sampling 128")
inputs = {"prompt": "one" * 128, "max_new_tokens": 64, "gen_method": "sampling"}
tpu_manager.generate(inputs)

print("cpmpling greedy 256")
inputs = {"prompt": "one" * 256, "max_new_tokens": 64, "gen_method": "greedy"}
tpu_manager.generate(inputs)

print("cpmpling greedy 128")
inputs = {"prompt": "one" * 128, "max_new_tokens": 64, "gen_method": "greedy"}
tpu_manager.generate(inputs)
...
async def generate(request: Request):
    ...
    generation_or_error = tpu_manager.generate(inputs)[0]
    return generation_or_error
