...
class FlaxGenerationMixin:
    ...
    def _greedy_search(
        ...
        def greedy_search_body_fn(state):
            ...
            # overwrite token only if token is new
            next_is_already_generated = state.sequences[:, state.cur_len] != pad_token_id
            next_token = (1 - next_is_already_generated) * next_token +  next_is_already_generated * state.sequences[:, state.cur_len]
